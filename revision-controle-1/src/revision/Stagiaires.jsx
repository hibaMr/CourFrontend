...
class Stagiaires extends React.Component{
    ...
    vider = ()=>{
        this.setState({stagiaire:{id:"",nom:"",prenom:"",age:"",groupe:""}})
    }
    ...
    componentDidMount = ()=>{
        axios.get('http://localhost:82/filier').then((res)=>{
            this.setState({filiers:res.data})
        })
        console.log(this.state.filiers)
    }
    ...
    render(){
        ...
        <h1 className="table-title">LIST STAGIAIRES</h1>
